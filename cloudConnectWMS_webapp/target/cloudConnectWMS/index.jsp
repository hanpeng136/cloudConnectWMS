...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="logo" style="background: #FFFFFF;padding-top:8px">
            <a href="index.html"><img src="source/images/logo-b.png" width="35" height="35" alt=""></a>
            <span class="state-overview state-value value" style="color:#5AB5DE;font-size:18px;"><b>云通WMS</b></span>
        </div>
